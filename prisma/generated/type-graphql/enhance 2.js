...
const outputsInfo = {
    ...
    VideoGroupBy: ["id", "tokenId", "title", "description", "authorId", "mintTx", "createdAt", "_count", "_min", "_max"],
    ...
    VideoCountAggregate: ["id", "tokenId", "title", "description", "authorId", "mintTx", "createdAt", "_all"],
...
const inputsInfo = {
    ...
    VideoWhereInput: ["AND", "OR", "NOT", "id", "tokenId", "title", "description", "authorId", "mintTx", "createdAt", "author", "comments", "likes"],
    VideoOrderByWithRelationInput: ["id", "tokenId", "title", "description", "authorId", "mintTx", "createdAt", "author", "comments", "likes"],
    VideoWhereUniqueInput: ["id", "AND", "OR", "NOT", "tokenId", "title", "description", "authorId", "mintTx", "createdAt", "author", "comments", "likes"],
    VideoOrderByWithAggregationInput: ["id", "tokenId", "title", "description", "authorId", "mintTx", "createdAt", "_count", "_max", "_min"],
    VideoScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "tokenId", "title", "description", "authorId", "mintTx", "createdAt"],
    ...
    VideoCreateInput: ["id", "tokenId", "title", "description", "mintTx", "createdAt", "author", "comments", "likes"],
    VideoUpdateInput: ["id", "tokenId", "title", "description", "mintTx", "createdAt", "author", "comments", "likes"],
    VideoCreateManyInput: ["id", "tokenId", "title", "description", "authorId", "mintTx", "createdAt"],
    VideoUpdateManyMutationInput: ["id", "tokenId", "title", "description", "mintTx", "createdAt"],
    ...
    VideoCountOrderByAggregateInput: ["id", "tokenId", "title", "description", "authorId", "mintTx", "createdAt"],
    ...
    VideoCreateWithoutAuthorInput: ["id", "tokenId", "title", "description", "mintTx", "createdAt", "comments", "likes"],
    ...
    VideoScalarWhereInput: ["AND", "OR", "NOT", "id", "tokenId", "title", "description", "authorId", "mintTx", "createdAt"],
    ...
    VideoCreateWithoutCommentsInput: ["id", "tokenId", "title", "description", "mintTx", "createdAt", "author", "likes"],
    ...
    VideoUpdateWithoutCommentsInput: ["id", "tokenId", "title", "description", "mintTx", "createdAt", "author", "likes"],
    UserCreateWithoutLikesInput: ["id", "videos", "comments"],
    UserCreateOrConnectWithoutLikesInput: ["where", "create"],
    VideoCreateWithoutLikesInput: ["id", "tokenId", "title", "description", "mintTx", "createdAt", "author", "comments"],
    ...
    VideoUpdateWithoutLikesInput: ["id", "tokenId", "title", "description", "mintTx", "createdAt", "author", "comments"],
    ...
    VideoCreateManyAuthorInput: ["id", "tokenId", "title", "description", "mintTx", "createdAt"],
    CommentCreateManyUserInput: ["text", "videoId", "tx"],
    LikeCreateManyUserInput: ["videoId", "tx"],
    VideoUpdateWithoutAuthorInput: ["id", "tokenId", "title", "description", "mintTx", "createdAt", "comments", "likes"],
