...
const modelsInfo = {
    ...
    User: ["id"],
    Comment: ["text", "userId", "videoId", "tx"],
    Like: ["userId", "videoId", "tx"],
    Video: ["id", "tokenId", "title", "description", "authorId", "mintTx", "createdAt"]
};
...
const outputsInfo = {
    ...
    CommentGroupBy: ["text", "userId", "videoId", "tx", "_count", "_min", "_max"],
    AggregateLike: ["_count", "_min", "_max"],
    LikeGroupBy: ["userId", "videoId", "tx", "_count", "_min", "_max"],
    AggregateVideo: ["_count", "_min", "_max"],
    VideoGroupBy: ["id", "tokenId", "title", "description", "authorId", "mintTx", "mintSignature", "createdAt", "_count", "_min", "_max"],
    ...
    UserMinAggregate: ["id"],
    UserMaxAggregate: ["id"],
    CommentCountAggregate: ["text", "userId", "videoId", "tx", "_all"],
    CommentMinAggregate: ["text", "userId", "videoId", "tx"],
    CommentMaxAggregate: ["text", "userId", "videoId", "tx"],
    ...
    VideoCountAggregate: ["id", "tokenId", "title", "description", "authorId", "mintTx", "mintSignature", "createdAt", "_all"],
    VideoMinAggregate: ["id", "tokenId", "title", "description", "authorId", "mintTx", "createdAt"],
    VideoMaxAggregate: ["id", "tokenId", "title", "description", "authorId", "mintTx", "createdAt"]
};
...
const inputsInfo = {
    ...
    CommentWhereInput: ["AND", "OR", "NOT", "text", "userId", "videoId", "tx", "user", "video"],
    CommentOrderByWithRelationInput: ["text", "userId", "videoId", "tx", "user", "video"],
    CommentWhereUniqueInput: ["userId_videoId", "AND", "OR", "NOT", "text", "userId", "videoId", "tx", "user", "video"],
    CommentOrderByWithAggregationInput: ["text", "userId", "videoId", "tx", "_count", "_max", "_min"],
    CommentScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "text", "userId", "videoId", "tx"],
    ...
    VideoWhereInput: ["AND", "OR", "NOT", "id", "tokenId", "title", "description", "authorId", "mintTx", "mintSignature", "createdAt", "author", "comments", "likes"],
    VideoOrderByWithRelationInput: ["id", "tokenId", "title", "description", "authorId", "mintTx", "mintSignature", "createdAt", "author", "comments", "likes"],
    VideoWhereUniqueInput: ["id", "AND", "OR", "NOT", "tokenId", "title", "description", "authorId", "mintTx", "mintSignature", "createdAt", "author", "comments", "likes"],
    VideoOrderByWithAggregationInput: ["id", "tokenId", "title", "description", "authorId", "mintTx", "mintSignature", "createdAt", "_count", "_max", "_min"],
    VideoScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "tokenId", "title", "description", "authorId", "mintTx", "mintSignature", "createdAt"],
    ...
    CommentCreateInput: ["text", "tx", "user", "video"],
    CommentUpdateInput: ["text", "tx", "user", "video"],
    CommentCreateManyInput: ["text", "userId", "videoId", "tx"],
    CommentUpdateManyMutationInput: ["text", "tx"],
    ...
    VideoCreateInput: ["id", "tokenId", "title", "description", "mintTx", "mintSignature", "createdAt", "author", "comments", "likes"],
    VideoUpdateInput: ["id", "tokenId", "title", "description", "mintTx", "mintSignature", "createdAt", "author", "comments", "likes"],
    VideoCreateManyInput: ["id", "tokenId", "title", "description", "authorId", "mintTx", "mintSignature", "createdAt"],
    VideoUpdateManyMutationInput: ["id", "tokenId", "title", "description", "mintTx", "mintSignature", "createdAt"],
    ...
    CommentUserIdVideoIdCompoundUniqueInput: ["userId", "videoId"],
    CommentCountOrderByAggregateInput: ["text", "userId", "videoId", "tx"],
    CommentMaxOrderByAggregateInput: ["text", "userId", "videoId", "tx"],
    CommentMinOrderByAggregateInput: ["text", "userId", "videoId", "tx"],
    ...
    VideoCountOrderByAggregateInput: ["id", "tokenId", "title", "description", "authorId", "mintTx", "mintSignature", "createdAt"],
    VideoMaxOrderByAggregateInput: ["id", "tokenId", "title", "description", "authorId", "mintTx", "createdAt"],
    VideoMinOrderByAggregateInput: ["id", "tokenId", "title", "description", "authorId", "mintTx", "createdAt"],
    ...
    VideoCreateWithoutAuthorInput: ["id", "tokenId", "title", "description", "mintTx", "mintSignature", "createdAt", "comments", "likes"],
    VideoCreateOrConnectWithoutAuthorInput: ["where", "create"],
    VideoCreateManyAuthorInputEnvelope: ["data", "skipDuplicates"],
    CommentCreateWithoutUserInput: ["text", "tx", "video"],
    ...
    VideoScalarWhereInput: ["AND", "OR", "NOT", "id", "tokenId", "title", "description", "authorId", "mintTx", "mintSignature", "createdAt"],
    ...
    CommentScalarWhereInput: ["AND", "OR", "NOT", "text", "userId", "videoId", "tx"],
    ...
    VideoCreateWithoutCommentsInput: ["id", "tokenId", "title", "description", "mintTx", "mintSignature", "createdAt", "author", "likes"],
    ...
    VideoUpdateWithoutCommentsInput: ["id", "tokenId", "title", "description", "mintTx", "mintSignature", "createdAt", "author", "likes"],
    UserCreateWithoutLikesInput: ["id", "videos", "comments"],
    UserCreateOrConnectWithoutLikesInput: ["where", "create"],
    VideoCreateWithoutLikesInput: ["id", "tokenId", "title", "description", "mintTx", "mintSignature", "createdAt", "author", "comments"],
    ...
    VideoUpdateWithoutLikesInput: ["id", "tokenId", "title", "description", "mintTx", "mintSignature", "createdAt", "author", "comments"],
    UserCreateWithoutVideosInput: ["id", "comments", "likes"],
    UserCreateOrConnectWithoutVideosInput: ["where", "create"],
    CommentCreateWithoutVideoInput: ["text", "tx", "user"],
    ...
    VideoCreateManyAuthorInput: ["id", "tokenId", "title", "description", "mintTx", "mintSignature", "createdAt"],
    CommentCreateManyUserInput: ["text", "videoId", "tx"],
    LikeCreateManyUserInput: ["videoId", "tx"],
    VideoUpdateWithoutAuthorInput: ["id", "tokenId", "title", "description", "mintTx", "mintSignature", "createdAt", "comments", "likes"],
    CommentUpdateWithoutUserInput: ["text", "tx", "video"],
    LikeUpdateWithoutUserInput: ["tx", "video"],
    CommentCreateManyVideoInput: ["text", "userId", "tx"],
    LikeCreateManyVideoInput: ["userId", "tx"],
    CommentUpdateWithoutVideoInput: ["text", "tx", "user"],
