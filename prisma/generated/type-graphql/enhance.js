...
const modelsInfo = {
    ...
    Video: ["id", "title", "description", "authorId", "mintTx", "createdAt"]
};
...
const outputsInfo = {
    ...
    VideoGroupBy: ["id", "title", "description", "authorId", "mintTx", "createdAt", "_count", "_min", "_max"],
    ...
    VideoCountAggregate: ["id", "title", "description", "authorId", "mintTx", "createdAt", "_all"],
    VideoMinAggregate: ["id", "title", "description", "authorId", "mintTx", "createdAt"],
    VideoMaxAggregate: ["id", "title", "description", "authorId", "mintTx", "createdAt"]
};
...
const inputsInfo = {
    ...
    VideoWhereInput: ["AND", "OR", "NOT", "id", "title", "description", "authorId", "mintTx", "createdAt", "author", "comments", "likes"],
    VideoOrderByWithRelationInput: ["id", "title", "description", "authorId", "mintTx", "createdAt", "author", "comments", "likes"],
    VideoWhereUniqueInput: ["id", "AND", "OR", "NOT", "title", "description", "authorId", "mintTx", "createdAt", "author", "comments", "likes"],
    VideoOrderByWithAggregationInput: ["id", "title", "description", "authorId", "mintTx", "createdAt", "_count", "_max", "_min"],
    VideoScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "description", "authorId", "mintTx", "createdAt"],
    ...
    VideoCreateInput: ["id", "title", "description", "mintTx", "createdAt", "author", "comments", "likes"],
    VideoUpdateInput: ["id", "title", "description", "mintTx", "createdAt", "author", "comments", "likes"],
    VideoCreateManyInput: ["id", "title", "description", "authorId", "mintTx", "createdAt"],
    VideoUpdateManyMutationInput: ["id", "title", "description", "mintTx", "createdAt"],
    ...
    VideoCountOrderByAggregateInput: ["id", "title", "description", "authorId", "mintTx", "createdAt"],
    VideoMaxOrderByAggregateInput: ["id", "title", "description", "authorId", "mintTx", "createdAt"],
    VideoMinOrderByAggregateInput: ["id", "title", "description", "authorId", "mintTx", "createdAt"],
    ...
    VideoCreateWithoutAuthorInput: ["id", "title", "description", "mintTx", "createdAt", "comments", "likes"],
    ...
    VideoScalarWhereInput: ["AND", "OR", "NOT", "id", "title", "description", "authorId", "mintTx", "createdAt"],
    ...
    VideoCreateWithoutCommentsInput: ["id", "title", "description", "mintTx", "createdAt", "author", "likes"],
    ...
    VideoUpdateWithoutCommentsInput: ["id", "title", "description", "mintTx", "createdAt", "author", "likes"],
    UserCreateWithoutLikesInput: ["id", "videos", "comments"],
    UserCreateOrConnectWithoutLikesInput: ["where", "create"],
    VideoCreateWithoutLikesInput: ["id", "title", "description", "mintTx", "createdAt", "author", "comments"],
    ...
    VideoUpdateWithoutLikesInput: ["id", "title", "description", "mintTx", "createdAt", "author", "comments"],
    ...
    VideoCreateManyAuthorInput: ["id", "title", "description", "mintTx", "createdAt"],
    CommentCreateManyUserInput: ["text", "videoId", "tx"],
    LikeCreateManyUserInput: ["videoId", "tx"],
    VideoUpdateWithoutAuthorInput: ["id", "title", "description", "mintTx", "createdAt", "comments", "likes"],
